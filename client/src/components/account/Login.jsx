            ...
            <Box>
                <Image src={imageURL} alt='Login' />
                {
                    account === "login" ?
                        ...
                        :
                        <Wrapper>
                            <TextField variant='standard' style={x} value={signup.name}  onChange={(e) => onInputChnage(e)} name="name" label="Enter your name" />
                            <TextField variant='standard' style={x} value={signup.username}  onChange={(e) => onInputChnage(e)} name="username" label="Enter username" />
                            <TextField variant='standard'  style={x}    value={signup.password} onChange={(e) => onInputChnage(e)} name="password" label="Enter password" />
                            {error && <Error>{error}</Error>}
